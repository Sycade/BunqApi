...
namespace Sycade.BunqApi.Endpoints
{
    public class PaymentEndpoint : Endpoint
    {
        ...
        public async Task<Id> CreateAsync(long fromAccountId, Alias to, Amount amount, string description, Session session)
        {
        ...
        public async Task<Payment[]> GetAllAsync(long monetaryAccountId, Session session)
        {
        ...
        public async Task<Payment> GetByIdAsync(long paymentId, long monetaryAccountId, Session session)
        {
